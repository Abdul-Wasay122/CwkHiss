...
// Checks that jobs have been loaded and can retrieve a job
    ...
    String[] xx = {"100","DESIGN","Kitchen","3","10","200"}; // Added "Kitchen" and changed to "DESIGN"
    ...
    // Checks just a few staff details
     ...
     public void checkDetailsOfAmir() {
         ...
         String[] mem = {"Amir","Planner","2", "300","30","Available", "Homebase"};
     ...
     public void checkDetailsOfBela() {
         String str = pr.getStaff("Bela");
           String[] mem = {"Bela","Consultant","2", "100","30","Available", "false"};
         boolean result = containsText(str,mem);
         assertTrue(result); 
     }
     ...
     public void checkDetailsOfEli() {
         ...
         String[] mem = {"Eli","Installer","7", "200","20","Available"};
         boolean result = containsText(str,mem);
         assertTrue(result); 
     }
