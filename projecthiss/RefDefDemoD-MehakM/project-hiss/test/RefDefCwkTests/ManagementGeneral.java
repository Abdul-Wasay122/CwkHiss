...
// Just checking getAllJobs for a few of the Jobs
    ...
    public void Job104InAllJobs() {
        String str = pr.getJob(104);
        boolean result = containsText2(str,"INSTALLATION","7","15");
        assertTrue(result);
    }
    
    @Test
    public void Job103InAllJobs() {
        String str = pr.getJob(103);
    ...
    @Test
    public void Job102InAllJobs() {
        String str = pr.getAllJobs();
        boolean result3 = containsText2(str,"INSTALLATION","3","30");
        assertTrue(result3);
    }
